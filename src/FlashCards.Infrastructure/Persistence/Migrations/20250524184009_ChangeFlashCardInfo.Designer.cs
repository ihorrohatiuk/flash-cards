...
namespace FlashCards.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20250524184009_ChangeFlashCardInfo")]
    partial class ChangeFlashCardInfo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlashCards.Infrastructure.Persistence.DataModels.FlashCardsUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FlashCards.Infrastructure.Persistence.DataModels.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FlashCards.Infrastructure.Persistence.DataModels.FlashCardsUnit", b =>
                {
                    b.HasOne("FlashCards.Infrastructure.Persistence.DataModels.User", "User")
                        .WithMany()
