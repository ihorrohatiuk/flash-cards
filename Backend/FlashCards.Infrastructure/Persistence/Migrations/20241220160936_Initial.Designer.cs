...
namespace FlashCards.Api.Migrations
{
    ...
    [Migration("20241220160936_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlashCards.Api.Models.FlashCardsUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FlashCards.Api.Models.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FlashCards.Api.Models.FlashCard", b =>
                {
                    b.HasOne("FlashCards.Api.Models.FlashCardsUnit", "FlashCardsUnit")
                        .WithMany()
            ...
            modelBuilder.Entity("FlashCards.Api.Models.FlashCardsUnit", b =>
                {
                    b.HasOne("FlashCards.Api.Models.User", "User")
                        .WithMany()
